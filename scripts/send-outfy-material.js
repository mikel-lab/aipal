...
const DEFAULT_MATERIAL_DIR =
  '/Users/mikelcobian/Repositorios Trabajo/socialmedia-instructions/outfy/outfy-material';
const DEFAULT_MESSAGE_FILE = 'message.txt';
const IMAGE_EXTENSIONS = new Set(['.png', '.jpg', '.jpeg', '.webp']);

function printHelp() {
  console.log(`Usage:
  node scripts/send-outfy-material.js [options]

Options:
  --dir <absolute_path>     Outfy material folder
